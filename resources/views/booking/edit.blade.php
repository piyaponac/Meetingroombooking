            ...
            <div class="card-body">
                ...
                <form role="form" id="form-booking">
                            ...
                            <div class="input-group">
                             ...
                             <label class="m-t-20" for = "building_id">เลือกอาคาร</label>
                                <div class="input-group" >    
                                                            ...
                                                            <option  value = "{{ $booking->building_id }}">{{ $booking->rooms->building->buildings_name }}</option>
                    ...
                    <div class="button-box m-t-20">
                        <button type="button" id="btn-update" class="btn btn-info" title="{{ $booking->id }}" >บันทึกข้อมูล</button>
...
@section('script')
    <script>
                $(document).ready(function(e) {
                    $('#booking_begin').timepicker({
                    showInputs: false,
                    showMeridian: false,
                    
                });

                $('#booking_end').timepicker({
                    showInputs: false,
                    showMeridian: false,
            ...
            var link = "{!! url('/') !!}"+"/booking/update/"+$(this).attr('title');
            $.ajax({
                url: link,
                method: 'PUT',
                data: form.serialize(),
